...
```{r approach1_diagram, fig.cap = "caption"}
DiagrammeR::grViz("
digraph {
...
```{r fits_diabetes_tree_1, eval = params$eval_slow, results = "show"}
set.seed(42)
...
```{r fits_diabetes_tree_1_export, include = FALSE, eval = params$eval_slow}
...
```{r fits_diabetes_tree_2_export, include = FALSE, eval = params$eval_slow}
teproj::export_ext_rds(
  fits_diabetes_tree_2,
  export = TRUE,
  dir = "data"
